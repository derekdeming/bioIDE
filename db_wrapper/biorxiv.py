...
I am developing a repo that contains database wrappers which extract data from an api in json format. Those wrappers currently are developed with modular and scalable code, using abstract classes when needed and async jobs as needed. The structure of the repo is as follows:

The current structure of this project is as follows: 
project_root/
├── __init__.py
├── db_wrapper/
│   ├── __init__.py
...
Here is an example of the code for the biorxiv.py database wrapper file: 
### BioRxiv api 
